...
General:
* for age > 125, recode age as NA
* for country, recode any [0-9] as NA_character_


Specifics (if not already recoded by general steps):

| id | variable | current entry | recode to |
| 20172213 | country | 1 | `NA_character_` -- do this by checking whole country column for numbers |
